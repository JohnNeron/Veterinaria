	...
	<div class="w3-container" id="where" style="padding-bottom: 32px;">
		<div class="w3-content" style="max-width: 700px">
			...
			<form:form action="/agregarUsuario" method="POST" modelAttribute="usuario">
				...
				<form:input path="username" cssClass="w3-input w3-padding-16 w3-border" />
				<form:errors path="username"></form:errors><br>
				
				<label>Contraseña:</label> 
				<form:password path="password" cssClass="w3-input w3-padding-16 w3-border" />
				<form:errors path="password"></form:errors><br>
				<form:hidden path="rol" cssClass="w3-input w3-padding-16 w3-border" value="2"/>
