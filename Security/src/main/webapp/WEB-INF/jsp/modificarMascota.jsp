...
<!-- Contact/Area Container -->
	<div class="w3-container" id="where" style="padding-bottom: 32px;">
		<div class="w3-content" style="max-width: 700px">
			...
			<form:form action="modificarMascota" method="POST" modelAttribute="mascota">
			
			<form:hidden path="id" value="${m.id}"/>

				<label>Nombre: </label>
				<form:input path="nombre" cssClass="w3-input w3-padding-16 w3-border" value= "${m.nombre }"/>
				<form:errors path="nombre"></form:errors>
				
				<p>Fecha de Nacimiento :</p> 
				<form:input path="fechaNacto" type="date" cssClass="w3-input w3-padding-16 w3-border" value= "${m.fechaNacto }" />
				<form:errors path="fechaNacto"></form:errors>
				
				<label>Fecha de Visita </label>
				<form:input path="fechaVisita" type="date" cssClass="w3-input w3-padding-16 w3-border" value= "${m.fechaVisita }"/>
				<form:errors path="fechaVisita"></form:errors>
				
				
				<label>Descripcion </label>
				<form:input path="descripcion" cssClass="w3-input w3-padding-16 w3-border" value= "${m.descripcion }"/>
				<form:errors path="descripcion"></form:errors>
				<input type="submit" value="Aplicar Cambios" class="w3-input w3-padding-16 w3-border">
		</form:form>
				
				<form:form action="listarMascotas" method="GET">
					<input type="submit" value="Volver" class="w3-input w3-padding-16 w3-border">
				</form:form>
		</div>
	</div>
