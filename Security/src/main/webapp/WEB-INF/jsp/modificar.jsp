...
<!-- Contact/Area Container -->
	<div class="w3-container" id="where" style="padding-bottom: 32px;">
		<div class="w3-content" style="max-width: 700px">
			...
			<form:form action="modificarDuenio" method="POST" modelAttribute="duenio">
				...
				<p>Apellido:</p> 
				<form:input path="apellido" cssClass="w3-input w3-padding-16 w3-border" value= "${d.apellido }" />
				<form:errors path="apellido"></form:errors>
				
				<label>Direccion </label>
				<form:input path="direccion" cssClass="w3-input w3-padding-16 w3-border" value= "${d.direccion }"/>
				<form:errors path="direccion"></form:errors>
				
				
				<label>Ciudad </label>
				<form:input path="ciudad" cssClass="w3-input w3-padding-16 w3-border" value= "${d.ciudad }"/>
				<form:errors path="ciudad"></form:errors>
				
				
				<label>Telefono </label>
				<form:input path="telefono" cssClass="w3-input w3-padding-16 w3-border" value= "${d.telefono }"/>
				<form:errors path="telefono"></form:errors>
				
				<form:hidden path="mascota" cssClass="w3-input w3-padding-16 w3-border" value= "${d.mascota}" />
